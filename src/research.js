...
const VERSION='technical-fundamental-v32-range-recent-veto';
...
function pooledSetup(symbol,tf,targetParts,threshold,directionalModel=null,directionalFloor=.55){
  ...
  const broadSideGate=chooseValidatedSides(adapted.model,targetCalExamples,threshold);
  const sideGate=stableSideGate(broadSideGate,adapted.selection);
